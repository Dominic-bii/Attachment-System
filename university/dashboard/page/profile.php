              ...
              <form>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">university Name</label>
                        <input value="<?php echo$university_name; ?>"   class="form-control"  type="text" >
                      </div>
                    </div>
                        <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">university Address</label>
