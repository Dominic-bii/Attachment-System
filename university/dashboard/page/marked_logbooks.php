...
$time_marks = $get['time_marks'];
$date = $get['date'];
$feedback = $get['feedback'];
$comment = $get['comment'];


$marks = $attendance + $punctuality + $skills + $office_applications + $technical_applications + $specialisation + $scientific_knowledge + $ability_to_learn + $acceptability_to_colleagues + $creativity + $planning + $time_marks ;
echo '<tr>
 <td>'.$student_email.'</td>
 <td>'.$marks.' out of 32</td>

 <td>'.$date.'</td>
<td>
                      <div class="btn-group btn-group-sm">
                      
                        <a href="./delete_logbook.php?log_id='.$id.'" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>   </tr>';
