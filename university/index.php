...
<head>
	...
	<title>University Supervisor-Login</title>
...
<div class="auth-wrapper">
	<div class="auth-content">
		<div class="card">
			...
			<?php
							// Check if user is not registered, and display registration link
							if (!isset($_SESSION['user_registered'])) {
								echo '<p><a href="signup.php">Not registered? Register here</a></p>';
							}
							?>
						</form>
					</div>
