		...
		<div class="card" >
			<div class="row align-items-center text-center">
				<div class="col-md-12" >
					...
					<div class="form-group mb-3">
							<label class="floating-label" for="Email">university Name</label><br>
							<input type="text" class="form-control" name="university_name"  placeholder="" required>
						</div>
				    <div class="form-group mb-3">
							<label class="floating-label" for="Email">university Address</label><br>
							<input type="text" class="form-control" name="university_address"  placeholder="" required>
						</div>
						<div class="form-group mb-3">
