      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <i class="nav-icon fas fa-edit"></i>
            ...
            <li class="nav-item">
            <a href="page/assess.php" class="nav-link">
         <i class="nav-icon fas fa-table"></i>
            ...
            <li class="nav-item">
            <a href="page/requests.php" class="nav-link">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="page/logbooks.php" class="small-box-footer">Logbooks <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
