...
$conn = DBconnect();
$sql = "SELECT * FROM leave_request WHERE accepted='0'";
...
<td>
                      <div class="btn-group btn-group-sm">
                        <a  href="./accept_request.php?log_id='.$id.' " class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="./delete_requests.php?request_id='.$id.'" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>   </tr>';
