...
$fetch = mysqli_fetch_array($query);
	...
	$sq = "INSERT INTO industrial_supervisor(firstname,lastname,email,company_name,company_address,department,phone)VALUES('$supervisor_fname','$supervisor_lname','$email','$company_name','$company_address','$department','$phone')";
