            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="from_date" class="form-control"  placeholder="Eg. 001/nrb" required>
                  </div>
                      <div class="form-group">
                    <label for="exampleInputEmail1">To Date</label>
                    <input type="date" name="to_date" class="form-control"  placeholder="Eg. 001/nrb" required>
                  </div>
