...
$query = mysqli_query($conn,$sql);
$get = mysqli_fetch_array($query);
$count_parents = mysqli_num_rows($query);
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <i class="nav-icon fas fa-search"></i>
          ...
          <li class="nav-item">
            <a href="page/industrial_supervisors.php" class="nav-link">
         <i class="nav-icon fas fa-search"></i>
              <p>
                  Industrial Supervisor List
       
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="page/universitysupervisors.php" class="nav-link">
         <i class="nav-icon fas fa-search"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="page/parents.php" class="nav-link ">
         <i class="nav-icon fas fa-search"></i>
              <p>
                Parents List
              </p>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-8">
           ...
           <h3><?php echo $count_supervisor; ?></h3>
                ...
                <h4>University Supervisor(s)</h4>
             </div>
              <div class="icon">
              
              </div>
              <a href="#" class="small-box-footer">University <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-8">
        ...
        <div class="small-box bg-info">
          ...
          <a href="#" class="small-box-footer">Parents <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
          <!-- ./col -->
        </div>
